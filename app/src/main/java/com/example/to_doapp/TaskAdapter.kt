...
class TaskAdapter(
    private val onUnassignClick: (ApiService.Taskinfo) -> Unit
) : RecyclerView.Adapter<TaskAdapter.TaskViewHolder>() {

    inner class TaskViewHolder(val binding: ItemViewTaskFragmentBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskViewHolder {
        val binding = ItemViewTaskFragmentBinding.inflate(
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            buttonUnassign.setOnClickListener {
                onUnassignClick(task)
            }
        }
    }
